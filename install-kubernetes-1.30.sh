...
echo "  If this node is to serve as the master, use 'kubeadm init' to initialize the cluster."
echo "  If this node is to serve as a worker, use 'kubeadm join <TOKEN>' to join the node to the cluster."
echo "  More detailed instructions are available in the README file."
echo -e "\n################################################################################################\n"